            ...
            <div class="grid  gap-8 grid-cols-1">
                <div class="flex flex-col ">
                    <div class="flex flex-col sm:flex-row items-center">
                        <h2 class="font-semibold font-poppins text-2xl text-center">Registrasi Bimbingan Konseling</h2>
                        <div class="w-full sm:w-auto sm:ml-auto mt-3 sm:mt-0"></div>
                    </div>
                    <div class="flex flex-col sm:flex-row items-center">
                        <h2 class="font-normal font-poppins text-lg text-center">Silahkan
                        </h2>
                            ...
                            <form action="<?= base_url() ?>Auth/registrasi" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mt-5 text-center md:text-right md:space-x-3 md:block flex flex-col-reverse">
                                    ...
                                    <button type="submit"
                                        ...
                                        name="registasi_BK" value="registasi_BK"
